...
RunConfiguration.setExecutionSettingFile('C:\\Users\\eneuhaus\\AppData\\Local\\Temp\\Katalon\\Test Cases\\I-CART\\6 - Edit Request (Admin)\\20181116_142702\\execution.properties')
...
not_run: WebUI.click(findTestObject('I-CART/Page_SPARCRequest Dashboard/span_glyphicon glyphicon-edit'))

not_run: WebUI.click(findTestObject('I-CART/Page_SPARCRequest Dashboard/label_Quantity Requested'))

not_run: WebUI.setText(findTestObject('I-CART/Page_SPARCRequest Dashboard/input_line_itemquantity'), '2')

not_run: WebUI.setText(findTestObject('I-CART/Page_SPARCRequest Dashboard/input_line_itemin_process_date'), '01/26/2018')

not_run: WebUI.setText(findTestObject('I-CART/Page_SPARCRequest Dashboard/input_line_itemcomplete_date'), '01/26/2018')

not_run: WebUI.click(findTestObject('I-CART/Page_SPARCRequest Dashboard/input_btn btn-primary'))

not_run: WebUI.click(findTestObject('I-CART/Page_SPARCRequest Dashboard/a_Clinical Services'))

not_run: WebUI.click(findTestObject('I-CART/Page_SPARCRequest Dashboard/a_Consolidated Request Tab'))

not_run: WebUI.click(findTestObject('I-CART/Page_SPARCRequest Dashboard/a_QuantityBilling Tab'))

not_run: WebUI.click(findTestObject('I-CART/Page_SPARCRequest Dashboard/a_Template Tab'))

not_run: WebUI.click(findTestObject('I-CART/Page_SPARCRequest Dashboard/a_Request Details'))

not_run: WebUI.click(findTestObject('I-CART/Page_SPARCRequest Dashboard/span_caret'))

not_run: WebUI.click(findTestObject('I-CART/Page_SPARCRequest Dashboard/span_Ictsicarta Test'))

not_run: WebUI.click(findTestObject('I-CART/Page_SPARCRequest Dashboard/span_caret_1'))

not_run: WebUI.click(findTestObject('I-CART/Page_SPARCRequest Dashboard/span_Complete'))
